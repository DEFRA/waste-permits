...
const STARTS_OR_ENDS_WITH_HYPHEN_MESSAGE = `<FIELD> can not start or end with a dash - please delete it`
const INVALID_CHARS_ERROR_MESSAGE = `<FIELD> contains text we can not accept - enter only numbers, letters, apostrophes, dashes and spaces`
const INVALID_CHARS_ERROR_MESSAGE_NO_NUMBERS = `<FIELD> contains text we can not accept - enter only letters, apostrophes, dashes and spaces`
