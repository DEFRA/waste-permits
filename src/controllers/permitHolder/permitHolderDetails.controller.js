...
const { PERMIT_HOLDER_NAME_AND_DATE_OF_BIRTH, COMPANY_NUMBER, LLP_COMPANY_NUMBER, PARTNERSHIP_TRADING_NAME, PUBLIC_BODY_TRADING_NAME } = require('../../routes')
  ...
  async doGet (request, h) {
    ...
    switch (permitHolderType) {
      ...
      case PUBLIC_BODY:
        ...
        return this.redirect({ request, h, redirectPath: PUBLIC_BODY_TRADING_NAME.path })
      case PARTNERSHIP:
        // Re-direct to partnership details flow
