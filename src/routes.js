...
const { CSV, DOC, DOCX, JPG, ODS, ODT, PDF, XLS, XLSX, AAI, ADI, AMI, APL, ASP, BPI, DEM, DIN, EMI, FAC, HRL, MET, PFL, ROU, RUF, SFC, TER, VAR } = require('./constants').FILE_TYPES
...
const Routes = {
  ...
  AIR_DISPERSION_MODELLING_REPORT: {
    ...
    validatorOptions: {
      fileTypes: [ AAI, ADI, AMI, APL, ASP, BPI, DEM, DIN, EMI, FAC, HRL, MET, ODS, PDF, PFL, ROU, RUF, SFC, TER, VAR, XLS, XLSX ]
    }
  },
