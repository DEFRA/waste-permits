...
const controller = new CheckYourEmailController({route: Constants.Routes.CHECK_YOUR_EMAIL, validator, cookieValidationRequired: false, applicationRequired: false})
