...
const controller = new CardProblemController({route: Constants.Routes.PAYMENT.CARD_PROBLEM, validator, cookieValidationRequired: false, viewPath: 'payment/cardProblem'})
