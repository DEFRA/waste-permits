...
const controller = new AddressManualInvoiceController({route: Constants.Routes.MANUAL_PERMIT_HOLDER, nextRoute: Constants.Routes.COMPANY_DECLARE_OFFENCES, validator})
