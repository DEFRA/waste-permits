...
const controller = new AddressSelectInvoiceController({route: Constants.Routes.SELECT_PERMIT_HOLDER, nextRoute: Constants.Routes.COMPANY_DECLARE_OFFENCES, validator})
