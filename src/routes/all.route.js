...
Object.entries(Routes)
  .forEach(([id, options]) => {
    let { types, controller, validator, baseRoute = 'baseRoute', cookieValidationRequired, applicationRequired, submittedRequired, tasksCompleteRequired, validatorOptions = {} } = options
    if (controller) {
      try {
        ...
        controller = new Controller({ route, validator, cookieValidationRequired, applicationRequired, submittedRequired, tasksCompleteRequired })
