...
// This flag can be set to bypass the virus scan (e.g. during development). Defaults to false.
config.bypassVirusScan = process.env.BYPASS_VIRUS_SCAN === 'TRUE' || false

// Password used for HMAC key generation, which is used to validate that a
// value in the cookie was generated by the server
config.cookieValidationPassword = process.env.COOKIE_VALIDATION_PASSWORD || 'COOKIE_VALIDATION_PASSWORD'
