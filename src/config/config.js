...
config.ADDRESS_LOOKUP_SERVICE = process.env.ADDRESS_LOOKUP_SERVICE  || 'ADDRESS_LOOKUP_SERVICE'
config.ADDRESS_LOOKUP_SERVICE_KEY = process.env.ADDRESS_LOOKUP_SERVICE_KEY  || 'ADDRESS_LOOKUP_SERVICE_KEY'

config.COMPANIES_HOUSE_SERVICE = process.env.COMPANIES_HOUSE_SERVICE  || 'COMPANIES_HOUSE_SERVICE'
