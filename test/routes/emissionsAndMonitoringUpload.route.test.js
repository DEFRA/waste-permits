...
lab.beforeEach(() => {
  ...
  sandbox.stub(EmissionsAndMonitoring, 'updateCompleteness').value(() => Promise.resolve({}))
...
lab.experiment('Emissions and monitoring upload tests:', () => {
  ...
  lab.experiment(`POST ${routePath}`, () => {
    ...
    helper.postSuccess({ payload: { 'emissions-and-monitoring': 'emissions-and-monitoring' } })
  })
})
