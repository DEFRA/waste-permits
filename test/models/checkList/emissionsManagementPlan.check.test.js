...
lab.beforeEach(() => {
  ...
  sandbox.stub(BaseCheck.prototype, 'getUploadedFileDetails').value(() => fakeEmissionsManagementPlans)
})
...
lab.experiment('EmissionsManagementPlan Check tests:', () => {
  lab.experiment('buildlines', () => {
    ...
    lab.test('(emissions management plan line) works correctly', async () => {
      ...
      Code.expect(linkType).to.equal('dust and emissions management plan')
