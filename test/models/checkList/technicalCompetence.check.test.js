...
lab.beforeEach(() => {
  ...
  sandbox.stub(BaseCheck.prototype, 'getUploadedFileDetails').value(() => fakeTechnicalCompetenceEvidence)
  sandbox.stub(BaseCheck.prototype, 'getUploadedFileDetails').value(() => fakeTechnicalManagersEvidence)
})
