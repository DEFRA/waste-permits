...
lab.experiment('Task List: BestAvailableTechniquesAssessment Model tests:', () => {
  lab.test(`checkComplete() method correctly returns FALSE when annotations don't exist`, async () => {
    ...
    const result = await BestAvailableTechniquesAssessment.checkComplete(mocks.context)
